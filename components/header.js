...
export default function Header() {
  ...
  return (
    <div className={"p-4 md:pt-16 md:pb-10 font-sans bg-gradient-to-t from-primary to-secondary " +  (currentRoute === "/ipitch" || currentRoute === "/searchProject" || currentRoute === "/vendorManagement"
        ? "hidden"
        : "")}>
      <div
        className={
